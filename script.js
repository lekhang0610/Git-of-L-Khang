...
/* cá theo chuột */
const follower = document.getElementById("followerFish");
...
/* cá giật mình khi di chuột */
document.addEventListener("mousemove", ()=>{
  document.querySelectorAll('.smallfish, #shark, #turtle').forEach(fish=>{
    fish.style.transform = "scale(1.2)";
    setTimeout(()=> fish.style.transform="",200);
  });
});

/* Patrick xoay khi click */
document.getElementById("diverPatrick").addEventListener("click", e=>{
  e.currentTarget.style.animation = "patrickSpin 1s linear";
  setTimeout(()=> e.currentTarget.style.animation="",1000);
});
